...
// Data siswa
const packageData = [
  { name: "Bersih-bersih Toilet", id: `Indor`, status: "Pagi" },
  { name: "Bersih-bersih Lapangan", id: `Lapangan Sekolah`, status: "Pagi" },
  { name: "Mencabut Rumput", id: `Sekolah`, status: "Siang" },
  { name: "Study Tour", id: `Yogyakarta`, status: "Pagi" },
  { name: "Berenang", id: `Cibanteng`, status: "Pagi" },
  { name: "PKK", id: `IPB`, status: "Siang" },
  { name: "Berenang", id: `Cibanteng`, status: "Pagi" },
  { name: "LDKS", id: `Gunung Salak`, status: "Malam" },
  { name: "Bersih-bersih Toilet", id: `Indor`, status: "Pagi" },
  { name: "Bersih-bersih Lapangan", id: `Lapangan sekolah`, status: "Pagi" },
  { name: "Mencabut Rumput", id: `Sekolah`, status: "Siang" },
  { name: "Study Tour", id: `Aceh`, status: "Pagi" },
  { name: "LDKS", id: `Arab`, status: "Malam" },
  { name: "PKK", id: `ITB`, status: "Siang" },
  { name: "Mendaki", id: `Gunung Slamet`, status: "Pagi" },
  { name: "Latihan Mitigasi Bencana", id: `Sekolah`, status: "Siang" },
  { name: "Outing", id: `Dufan`, status: "Malam" },
  { name: "Mendaki", id: `Bukit kayu`, status: "Pagi" },
  { name: "Latihan Mitigasi Bencana", id: `Rumah sakit`, status: "Siang" },
  { name: "Outing", id: `Bali`, status: "Malam" },
];
  ...
  return (
    <div className="rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <div className="max-w-full overflow-x-auto">
        <div className="w-full grid justify-end mb-5 px-5">
          <button className="bg-transparent hover:bg-blue-500 text-blue-500 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded-lg">Tambah</button>
        </div>
        <table className="w-full table-auto">
          ...
          <tbody>
            {currentData.map((packageItem, index) => (
              <tr key={index}>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${index === currentData.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                  <h5 className="text-dark dark:text-white">{packageItem.name}</h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === currentData.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                ...
                >
                  <p
                    className={`inline-flex rounded-full px-3.5 py-1 text-body-sm font-medium ${packageItem.status === "Pagi"
                      ? "bg-[#219653]/[0.08] text-[#219653]"
                      : packageItem.status === "Siang"
                  ...
                  <div className="flex items-center justify-end space-x-3.5">
                    <button className="hover:text-primary">
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <path d="M17.414 2.586a2 2 0 00-2.828 0L14 3.172 16.828 6l.586-.586a2 2 0 000-2.828zM13 7l-1.586-1.586-6.707 6.707A1 1 0 004 13v2h2a1 1 0 00.707-.293l6.707-6.707L13 7z" />
                      </svg>
                    </button>
