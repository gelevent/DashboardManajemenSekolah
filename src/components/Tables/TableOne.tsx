...
// Data siswa
const packageData = [
  { name: "Gemi Widodo", id: `2233309`, status: "Hadir" },
  { name: "Mufiz IhsanulHaq", id: `2233313`, status: "Hadir" },
  { name: "Dhiraqi AK", id: `2233305`, status: "Sakit" },
  { name: "Ahmad Tauhid", id: `2233302`, status: "Hadir" },
  { name: "Adli Fathi", id: `2233301`, status: "Izin" },
  { name: "Saepoel Romadhon", id: `2233316`, status: "Sakit" },
  { name: "Gemi Widodo", id: `2233309`, status: "Hadir" },
  { name: "Mufiz IhsanulHaq", id: `2233313`, status: "Hadir" },
  { name: "Dhiraqi AK", id: `2233305`, status: "Sakit" },
  { name: "Ahmad Tauhid", id: `2233302`, status: "Hadir" },
  { name: "Adli Fathi", id: `2233301`, status: "Izin" },
  { name: "Saepoel Romadhon", id: `2233316`, status: "Sakit" },
  { name: "John Doe", id: `2233320`, status: "Hadir" },
  { name: "Jane Smith", id: `2233321`, status: "Hadir" },
  { name: "Albert Einstein", id: `2233322`, status: "Sakit" },
  { name: "Marie Curie", id: `2233323`, status: "Izin" },
  { name: "John Doe", id: `2233320`, status: "Hadir" },
  { name: "Jane Smith", id: `2233321`, status: "Hadir" },
  { name: "Albert Einstein", id: `2233322`, status: "Sakit" },
  { name: "Marie Curie", id: `2233323`, status: "Izin" },
          ...
          <tbody>
            {currentData.map((packageItem, index) => (
              <tr key={index}>
                ...
                >
                  <p
                    className={`inline-flex rounded-full px-3.5 py-1 text-body-sm font-medium ${packageItem.status === "Hadir"
                        ? "bg-[#219653]/[0.08] text-[#219653]"
                        : packageItem.status === "Sakit"
